...
public class SampledRandomVariable_treemap<Type> {

	/**
	 * Tracks the frequency at which each sample has been observed.
	 */
	private TreeMap<Type, Long> occurrenceCount;
	 ...
	 * of observation data.
	 */
	protected SampledRandomVariable_treemap(TreeMap<Type, Long> backingMap)
	{
		backingMap.clear();
	...
	public SampledRandomVariable_treemap() 
	{
		this(new TreeMap<Type, Long>());
	}
