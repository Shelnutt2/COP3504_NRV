...
public class NumericalRandomVariable_treemap<Type extends Number> extends
		SampledRandomVariable_treemap<Type> 
{
	...
	public NumericalRandomVariable_treemap()
	{
		super();
	...
	public NumericalRandomVariable_treemap(TreeMap<Type, Long> backingMap)
	{
		super(backingMap);
